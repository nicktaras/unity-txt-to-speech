    ...
    public class Speaker : MonoBehaviour
    {
        ...
        public void OnEnable()
        {
            ...
            else
            {
                ...
                if (!Util.Helper.isEditorMode && Util.Config.DONT_DESTROY_ON_LOAD && speaker != this)
                {
...
*/
        ...
        public static string SpeakNative(Model.Wrapper wrapper)
        {
            ...
            return System.Guid.NewGuid().ToString(); //fake uid
        }
        ...
        public static void SpeakNativeInEditor(string text, Model.Voice voice = null, float rate = 1f, float pitch = 1f, float volume = 1f)
        {
            if (Util.Helper.isEditorMode)
            {
                if (voiceProvider != null)
        ...
        /// <param name="volume">Volume of the speaker in percent (1 = 100%, default: 1, optional).</param>
        /// <param name="outputFile">Saves the generated audio to an output file (without extension, optional).</param>
        public static void GenerateInEditor(string text, Model.Voice voice = null, float rate = 1f, float pitch = 1f, float volume = 1f, string outputFile = "")
        {
            if (Util.Helper.isEditorMode)
            {
                if (voiceProvider != null)
