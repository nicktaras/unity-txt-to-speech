    ...
    public class VoiceProviderMacOS : BaseVoiceProvider
    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    using (System.Diagnostics.Process speakProcess = new System.Diagnostics.Process())
                    {
                        ...
                        System.Threading.Thread worker = new System.Threading.Thread(() => startProcess(speakProcess)) { Name = wrapper.Uid.ToString() };
                        worker.Start();
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        using (System.Diagnostics.Process speakToFileProcess = new System.Diagnostics.Process())
                        {
                            ...
                            System.Threading.Thread worker = new System.Threading.Thread(() => startProcess(speakToFileProcess)) { Name = wrapper.Uid.ToString() };
                            worker.Start();
        ...
        private IEnumerator getVoices()
        {
            ...
            using (System.Diagnostics.Process voicesProcess = new System.Diagnostics.Process())
            {
                ...
                System.Threading.Thread worker = new System.Threading.Thread(() => startProcess(voicesProcess, Util.Constants.DEFAULT_TTS_KILL_TIME));
                worker.Start();
        ...
        private void startProcess(System.Diagnostics.Process process, int timeout = 0)
        {
            try
            {
                process.Start();
