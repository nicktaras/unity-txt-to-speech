...
namespace Crosstales.RTVoice.Util
{
    ...
    public static class Constants
    {
        ...
        public const string ASSET_VERSION = "2.9.0";

        /// <summary>Build number of the asset.</summary>
        public const int ASSET_BUILD = 290;
        ...
        public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2017, 11, 18);
